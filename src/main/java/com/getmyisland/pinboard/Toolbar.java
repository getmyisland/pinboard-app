...
public class Toolbar extends JToolBar {
    public Toolbar() {
        ...
        cleanBoardButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                int input = JOptionPane.showConfirmDialog(Main.instance.getFrame(), "The whole board will be deleted!",
                        "Delete board", JOptionPane.OK_CANCEL_OPTION, JOptionPane.WARNING_MESSAGE);
